...
public class LoginController {
    ...
    public String postloginRequest(@RequestParam("userId") String userId, @RequestParam("userPw") String userPw,
            Model model) {
        ...
        // 지금 user를 id와 pw을 이용해서 확인하기 때문에 id 혹은 pw 요소 하나만 틀릴 경우에는 회원정보가 있음에도 불구하고 user를
        // 찾지못함
