        ...
        <nav aria-label="Page navigation example">
           <ul class="pagination justify-content-center">
               <c:if test="${totalPage != 0}">
                    <li class="page-item"><a class="page-link" href="/boardOnSearchList?page=${currentPage -1}">이전</a></li>
                    <li class="page-item"><a class="page-link" href="/boardOnSearchList?page=${currentPage +1}">다음</a></li>
               </c:if>
           </ul>
       </nav>
   </div>
